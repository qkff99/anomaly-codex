...
```ini title="gamedata/configs/misc/task/task_manager.ltx"
[my_task]
...
```lua title="gamedata/scripts/my_task.script"
...
### Using the game's dynamic random tasks
