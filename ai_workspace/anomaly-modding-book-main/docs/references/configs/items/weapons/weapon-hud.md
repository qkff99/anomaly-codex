...
|---|---|---|---|
| item_visual | Weapon <GlossaryTerm termId="hud">*_hud models</GlossaryTerm> | anomaly_weapons\wpn_akm\wpn_akm_hud.ogf | File path relative to the `gamedata\meshes` folder |
