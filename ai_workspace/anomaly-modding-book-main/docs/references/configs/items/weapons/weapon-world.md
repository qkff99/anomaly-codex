...
| hud | Section with parameters for <GlossaryTerm termId="hud">*_hud models</GlossaryTerm> | wpn_akm_hud | Section name |
| visual | <GlossaryTerm termId="world">*_world model</GlossaryTerm> | dynamics\weapons\wpn_akm\wpn_akm.ogf | Path to file |
