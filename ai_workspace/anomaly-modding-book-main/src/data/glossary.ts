...
const glossaryData: GlossaryData = {
  ...
  terms: [
    ...
    },
    {
      ...
      term: 'Emission',
      definition:
        'A catastrophic release of energy from the Zone that transforms living beings and creates new anomalies.',
      category: 'Game Concepts',
      related: [{ id: 'anomaly', term: 'Anomaly' }],
    },
    {
      ...
      term: 'Addon',
      definition:
        'A modification that adds new content or features to the game without changing core gameplay mechanics.',
      category: 'Modding Terminology',
      related: [{ id: 'mod', term: 'Mod' }],
    },
    {
      id: 'mod',
      term: 'Mod',
      definition:
        'Short for modification, a user-made alteration to the game that changes or expands its content, mechanics, or visuals.',
      category: 'Modding Terminology',
      related: [{ id: 'addon', term: 'Addon' }],
    },
    {
      id: 'offline',
      term: 'Offline',
    ...
    },
    {
      ...
      term: 'LuaJIT',
      definition:
        'LuaJIT is a Just-In-Time Compiler for the Lua programming language. Anomaly uses LuaJIT 2.0.4.',
      category: 'Technical Terms',
      related: [],
    },
    {
